...
const BATCH = [
  ...
  {image: 'https://www.gwinnettrecycles.com/wp-content/uploads/2019/07/New-uses-for-recyclables-1150x863.jpg', title: 'Assortment of Arts & Crafts supplies', description: "Finished my art degree and will need to purchase new supplies for work. Would love to give these away!", location: "Union Square", address: '201 Park Ave S, New York NY 10003', locationNotes: "NYU Resident's Halls. I will be by the revolving doors at 1:30pm on Thursdays. Let me know you're from ReClaim", isSorted: false, isClaimed: false, updatedAt: new Date(), createdAt: new Date(),
},
  {image: 'https://news.unl.edu/sites/default/files/styles/large_aspect/public/PA240015_0.jpg?itok=6JKi1M86', title: 'Plastic Bottles', description: "I'm a superintendent at a high school looking for help to recycle! I collect more plastic bottles a week than I can handle...willing to give away half (about 150 bottles)", location: "The Bronx", address: '345 John Jay St, The Bronx, New York 10453', locationNotes: "Walk through the parking lot to the back of the school near the track field. My last round is at 5pm. See you then.", isSorted: true, isClaimed: true, updatedAt: new Date(), createdAt: new Date(),
},
  {image: 'https://static-nexus.prod.postmedia.digital/wp-content/uploads/2020/03/BI.LDN20110727SRboxgood.jpg', title: 'Newspapers', description: 'My husband reads the paper every morning and I go through a lot of magazines. We currently have a batch that we would like to dispose of the paper properly. See picture. :)', location: "Brooklyn", address: '456 Richards St, Brooklyn, New York 11256', locationNotes: "We will leave them on the corner next to the USPS mailbox on Sunday", isSorted: true, isClaimed: true, updatedAt: new Date(), createdAt: new Date(),
}
];
module.exports = {
